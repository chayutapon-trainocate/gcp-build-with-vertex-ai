...
gen_model = GenerativeModel("gemini-2.0-flash", generation_config={"temperature": 0})
...
def ask_gemini(question):
    ...
    complete_prompt = prompt_template.format(question=question, context=context)
    ...
    response_obj = gen_model.generate_content(
        complete_prompt,
